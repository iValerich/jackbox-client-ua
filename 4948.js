(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    [4948], {
        14948: (e, t, s) => {
            ...
            const U = {
                en: {
                    STATUS_GAME_FULL: "Гра переповнена",
                    STATUS_GAME_STARTED: "Гра почалася",
                    STATUS_ROOM_NOT_FOUND: "Кімнату не знайдено",
                    SUBMIT_GAME_FULL: "ГРА ПЕРЕПОВНЕНА",
                    SUBMIT_GAME_STARTED: "ГРА ПОЧАЛАСЯ",
                    SUBMIT_JOIN_AUDIENCE: "ПРИЄДНУЙТЕСЬ ДО ГЛЯДАЧІВ",
                    SUBMIT_RECONNECT: "ПОВТОРНЕ З'ЄДНАННЯ",
                    SUBMIT_TWITCH_LOGIN: "УВІЙТИ ЧЕРЕЗ TWITCH",
                    TOS_WARNING: "Натискаючи {submit}, ви погоджуєтеся з нашими [tos]Умовами Використання[/tos]",
                    ...
                    STRING_LOBBY_CENSOR_CONFIRM: "Це прибере нікнейм гравця, його аватар, написи та малюнки. Ви впевнені?",
                    STRING_CENSOR_INFO: "натисніть на <span class='censor-button-image censor-button-black'></span>, щоб зацензурувати гравця до кінця гри, видаляючи його відповіді, нікнейм і аватар (це доволі жорстоко)",
                    STRING_SKIP: "пропустити!",
                    STRING_THANK_YOU: "дякуємо за ваш малюнок",
                    STRING_DRAWING_OVER: "час малювання скінчився!",
                    STRING_CENSOR_LIE_CONFIRM: "це видалить запис цього гравця та всі майбутні відповіді та малюнки. ви впевнені?",
                    STRING_YES: "Так",
                    STRING_NO: "Ні",
                    STRING_THANK_AUDIENCE: "дякуємо за ваш внесок, глядачу!",
                    STRING_AUDIENCE_WELCOME_0: "вітаємо серед глядачів<br>це весело!",
                    STRING_AUDIENCE_WELCOME_1: "вітаємо серед глядачів<br>ти зможеш взяти участь дуже скоро",
                    STRING_AUDIENCE_WELCOME_2: "вітаємо серед глядачів<br>веселощі прийдуть з хвилини на хвилину",
                    STRING_AUDIENCE_WELCOME_3: "вітаємо серед глядачів<br>ми чекали саме тебе",
                    STRING_AUDIENCE_WELCOME_4: "вітаємо серед глядачів<br>не так весело, як мати версію гри, але веселіше, ніж сидіти самому і нічого не робити",
                    STRING_AUDIENCE_WELCOME_5: "вітаємо серед глядачів<br>чим більше, тим краще",
                    STRING_AUDIENCE_WELCOME_6: "вітаємо серед глядачів<br>один з нас, один з нас",
                    ...
                    STRING_AUDIENCE_WELCOME_9: "вітаємо серед глядачів<br>ти любиш дивитися, а?",
                    ...
                    STRING_AUDIENCE_WELCOME_11: "вітаємо серед глядачів<br>будь ласка, не організовуйте повстання",
                    STRING_AUDIENCE_WELCOME_12: "вітаємо серед глядачів<br>почувайся як вдома",
                    STRING_AUDIENCE_WELCOME_13: "вітаємо серед глядачів<br>сподіваємося, ти любиш оцінювати людей",
                    STRING_AUDIENCE_WELCOME_14: "вітаємо серед глядачів<br>глибоко вдихни, скоро почнеться шоу",
                    STRING_AUDIENCE_WELCOME_15: "вітаємо серед глядачів<br>насолоджуйтеся",
                    STRING_AUDIENCE_WELCOME_16: "вітаємо серед глядачів<br>з усіх глядачів, саме ти наш улюбленець",
                    STRING_AUDIENCE_WELCOME_17: "вітаємо серед глядачів<br>мрії збуваються!",
                    STRING_AUDIENCE_WELCOME_18: "вітаємо серед глядачів<br>це другий по рівню цікавості спосіб грати в цю гру!",
                    STRING_AUDIENCE_WELCOME_19: "вітаємо серед глядачів<br>ми написали це додаткове речення спеціально для тебе",
                    STRING_AUDIENCE_WELCOME_20: "вітаємо серед глядачів<br>будь ласка, займи своє місце",
                    STRING_AUDIENCE_WELCOME_21: "вітаємо серед глядачів<br>тооооооооооож... як твої справи?",
                    STRING_AUTHOR_MESSAGE_0: "Ви це намалювали.<br>Можете подумати хвилинку чи дві.",
                    STRING_AUTHOR_MESSAGE_1: "Ти намалював це.<br>Може, звернешся до лікаря?",
                    ...
                    STRING_AUTHOR_MESSAGE_4: "Ти намалював це.<br>Дороги назад немає!",
                    STRING_AUTHOR_MESSAGE_5: "Ти намалював це.<br>Розслабся.",
                    STRING_AUTHOR_MESSAGE_6: "Ти намалював це.<br>Насолоджуйся моментом.",
                    STRING_AUTHOR_MESSAGE_7: "Ти намалював це.<br>Уже запізно щось змінювати.",
                    STRING_AUTHOR_MESSAGE_8: "Ти намалював це.<br>Тут не вийде звинуватити когось іншого.",
                    STRING_AUTHOR_MESSAGE_9: "Ти намалював це.<br>І твоє життя назавжди зміниться.",
                    STRING_AUTHOR_MESSAGE_10: "Ти намалював це.<br>Ура?",
                    STRING_AUTHOR_MESSAGE_11: "Ти намалював це.<br>Без коментарів.",
                    STRING_AUTHOR_MESSAGE_12: "Ти намалював це.<br>Могло бути й гірше.",
                    STRING_AUTHOR_MESSAGE_13: "Ти намалював це.<br>Вини себе за це.",
                    STRING_AUTHOR_MESSAGE_14: "Ти намалював це.<br>Тож...так...",
                    STRING_AUTHOR_MESSAGE_15: "Ти намалював це.<br>Не хвилюйся, це скоро скінчиться.",
                    STRING_AUTHOR_MESSAGE_16: "You drew this.<br>Feel as good about that as you can.",
                    STRING_AUTHOR_MESSAGE_17: "Ти намалював це.<br>Це мистецтво.",
                    STRING_AUTHOR_MESSAGE_18: "Ти намалював це.<br>Дякую?",
                    STRING_AUTHOR_MESSAGE_19: "Ти намалював це.<br>Дай п'ять!",
                    STRING_AUTHOR_MESSAGE_20: "Ти намалював це.<br>Можеш взяти невелику перерву.",
                    STRING_AUTHOR_MESSAGE_21: "Ти намалював це.<br> Стався спокійно до цього.",
                    STRING_AUTHOR_MESSAGE_22: "Ти намалював це.<br> Все мине.",
                    STRING_AUTHOR_MESSAGE_23: "Ти намалював це.<br>Змирися.",
                    STRING_AUTHOR_MESSAGE_24: "You drew this.<br>Confront the consequences.",
                    STRING_AUTHOR_MESSAGE_25: "Ти намалював це.<br>Що зроблено, те зроблено.",
                    STRING_AUTHOR_MESSAGE_26: "Ти намалював це?<br>Все нормально. Все буде нормально.",
                    STRING_AUTHOR_MESSAGE_27: "Ти намалював це.<br>Ти все ще заслуговуєш любові, можливо.",
                    STRING_AUTHOR_MESSAGE_28: "Ти намалював це.<br>Дякую.",
                    STRING_AUTHOR_MESSAGE_29: "You drew this.<br>Creation is its own gift.",
                    STRING_AUTHOR_MESSAGE_30: "Ти намалював це.<br> Ха-ха-ха-ха.",
                    STRING_AUTHOR_MESSAGE_31: "Ти намалював це.<br>І я люблю тебе за таке.",
                    STRING_AUTHOR_MESSAGE_32: "Ти намалював це.<br>Дивно.",
                    ...
                    STRING_AUTHOR_MESSAGE_38: "Ти намалював це.<br>Ти.",
                    STRING_AUTHOR_MESSAGE_39: "You drew this.<br>Only history can judge you.",
                    STRING_AUTHOR_MESSAGE_40: "Ти намалював це.<br>Насолоджуйся цим.",
                    STRING_AUTHOR_MESSAGE_41: "Ти намалював це.<br>Це добре.",
                    STRING_SUBMIT_ALERT: "ви написали щось схоже до справжньої назви або ввели щось, що вже ввів хтось інший!",
                    ERROR_DRAWING_EMPTY: "Ви мусите намалювати щось!",
                    STRING_SKIP_BUTTON: "пропустити (це образливо)",
                    STRING_SKIP_BUTTON_CONFIRM: "ви впевнені?",
                    STRING_TEXT_SUBMIT_ALERT: "вам потрібно щось ввести!",
                    STRING_ERROR_INVALID_ROOM_CODE: "Невірний код кімнати",
                    STRING_ERROR_UNABLE_TO_JOIN: "Не вдається під'єднатися до серверів Jackbox Games. Зазвичай таке спричинено блокувальниками реклами або іншими розширеннями, що змінюють конфіденційність.",
                    STRING_ERROR_WEBSOCKETS_REQUIRED: "Ваш браузер не підтримує WebSockets.",
                    STRING_ERROR_INVALID_APP_ID: "Недійсний ідентифікатор програми для кімнати: ",
                    STRING_SETTINGS: "Налаштування",
                    STRING_DYSLEXIC_FONT: "Дислексичний шрифт",
                    STRING_LARGE_FONT: "Великий шрифт",
                    LANGUAGE: "Мова",
                    LOGIN: "Увійти",
                    STRING_CAMERA_WARNING: "[b]УВАГА:[/b] Ми не можемо знайти твою камеру, проте ти все ще можеш грати у цю гру без фото. Якщо це здається неправильним, спробуй приєднатися з іншого браузера.",
                    STRING_STYLE_WARNING: "[b]УВАГА:[/b] Ваш браузер виглядає трохи застарілим, він матиме деякі проблеми з відображенням цієї гри.",
                    STRING_NAME: "ІМʼЯ",
                    STRING_NAME_PLACEHOLDER: "ВВЕДІТЬ ВАШЕ ІМʼЯ",
                    STRING_CANVAS_COMPATIBILITY: "На жаль, ваш браузер не підтримується.",
                    STRING_MENU_HELP: "ДОПОМОГА",
                    STRING_MENU_TWITCH: "TWITCH",
                    STRING_MENU_LOGOUT: "ВИЙТИ",
                    STRING_MENU_MERCH: "МЕРЧ",
                    STRING_MENU_PAST_GAMES: "МИНУЛІ ІГРИ",
                    STRING_MENU_MAILING_LIST: "СПИСОК АДРЕСАТІВ",
                    ERROR_UNSUPPORTED_BROWSER: "Ця гра не підтримується в цьому браузері. Натисніть на '?' або HELP, щоб переглянути список сумісних браузерів.",
                    ERROR_UNSUPPORTED_WEBSOCKETS: "Ваш браузер не підтримує WebSockets.",
                    ERROR_ROOM_FULL: "Кімната заповнена",
                    ERROR_AUDIENCE_FULL: "Кількість глядачів на максимумі",
                    ERROR_INVALID_ROOMCODE: "Невірний код кімнати",
                    ERROR_UNABLE_TO_CONNECT: "Не вдається під'єднатися до серверів Jackbox Games. Зазвичай таке спричинено блокувальниками реклами або іншими розширеннями, що змінюють конфіденційність.",
                    ERROR_GAME_LOCKED: "Гра триває. Зачекайте нової гри, щоб почати.",
                    AD_AVAILABLE_NOW: "Доступно зараз!",
                    AD_ON_SALE: "Розпродаж!",
                    STRING_PASSWORD_REQUIRED_TITLE: "Потрібен пароль",
                    STRING_PASSWORD_REQUIRED_BODY: "Будь ласка, введіть пароль або приєднуйтесь як глядач",
                    STRING_PASSWORD_JOIN_AS_PLAYER: "Приєднатися як гравець",
                    STRING_PASSWORD_JOIN_AS_AUDIENCE: "Приєднатися до глядачів",
                    STRING_ERROR_SERVER_ERROR: "Не вдалося приєднатися до кімнати через помилку сервера",
                    STRING_ERROR_TWITCH_COOKIES: "Для входу через Twitch потрібні файли cookie",
                    STRING_ERROR_GAME_UNSUPPORTED: "Ця гра не підтримується в цьому браузері.",
                    STRING_ERROR_REQUIRES_TWITCH_LOGIN: "Гра вимагає входу через Twitch",
                    STRING_ERROR_ROOM_IS_LOCKED: "Гра заблокована",
                    STRING_ERROR_INCORRECT_PASSWORD: "Невірний пароль",
                    STRING_ERROR_GENERIC: "Помилка приєднання до гри",
                    STRING_ERROR_CONNECTION: "Помилка підключення",
                    ERROR_FILTER_NAME: "У цій грі ввімкнено фільтр ненормативної лексики. Виберіть інше ім'я."
                },
                fr: {
