        ...
        14948: (e, t, s) => {
            ...
            const U = {
                en: {
                    ...
                    STRING_LOBBY_CENSOR_CONFIRM: "Це прибере нікнейм гравця, його аватар, усі його написи та малюнки. Ви впевнені?",
                    STRING_CENSOR_INFO: "натисніть на <span class='censor-button-image censor-button-black'></span>, щоб зацензурувати гравця до кінця гри, видаляючи їхні відповіді, нікнейм і аватар(це доволі жорстоко)",
                    STRING_SKIP: "пропустити!",
                    STRING_THANK_YOU: "дякуємо за ваш малюнок",
                    STRING_DRAWING_OVER: "час малювання вичерпано!",
                    STRING_CENSOR_LIE_CONFIRM: "це видалить запис цього гравця та всі майбутні відповіді та малюнки. ти впевнений?",
                    STRING_YES: "Так",
                    STRING_NO: "Ні",
                    ...
                    STRING_AUDIENCE_WELCOME_3: "вітаємо серед глядачів<br>ми чекали тебе",
